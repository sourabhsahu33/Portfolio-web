...
const Data = () => {
    return (
        <div className="home__data">
            <h1 className='home__title'> Sourabh Sahu
                <svg
                    width="36"
                    height="36"
                    viewBox="0 0 48 48"
            ...
            <h2 className='home__subtitle'>Front-End Developer & Cyber Security Enthusiast </h2>
            <p className='home__description'>  "Believe You Can And You're Halfway There." ! 
            Hello, folks! Currently, I am pursuing an Integrated M.Tech in Computer Science with a specialization in Cybersecurity. I am currently in the fourth year of my engineering journey.</p>
